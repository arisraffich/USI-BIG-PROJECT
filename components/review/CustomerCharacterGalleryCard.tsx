...
export function CustomerCharacterGalleryCard({ character, isMain = false }: CustomerCharacterGalleryCardProps) {
    ...
    return (
        <div className="flex flex-col items-center bg-white rounded-xl shadow-sm border w-full h-full transition-all hover:shadow-md overflow-hidden">
            {/* Large Image Area */}
            <div className="w-full aspect-square relative bg-gray-50 border-b">
                {character.image_url ? (
                    <img
