  ...
  return (
    <Card id={`character-${character.id}`} className="hover:shadow-lg transition-shadow relative">
      <CardContent className="pt-6">
        {/* Delete button in top right corner - only for secondary characters */}
        {!isMainCharacter && (
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    Are you sure you want to delete "{displayName}"? This action cannot be undone and will remove the character from all pages.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
