...
export default async function ReviewPage({ params }: { params: Promise<{ token: string }> }) {
  ...
  const characters = allCharacters?.filter((c: { is_main: boolean; customer_image_url?: string | null; image_url?: string | null }) => c.is_main || c.customer_image_url || !c.image_url) || null
